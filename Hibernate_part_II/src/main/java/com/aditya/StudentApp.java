...
public class StudentApp {
    public static void main(String[] args) {
        ...
        laptop4.setLid( 40 );
        laptop4.setBrand( "MSI" );
        laptop4.setModel( "MSI PRO" );
        laptop4.setG_card( "RTX4050" );
        laptop4.setPrice( 80000 );
        ...
        sd1.setLaptops( Arrays.asList( laptop3 ) );
        sd2.setLaptops( Arrays.asList( laptop4 ) );
